...
client.on(Events.InteractionCreate, async (interaction) => {
    ...
    try {
        ...
        if (!interaction.guild) {
            console.log(`Command ${interaction.commandName} executed in DM by ${interaction.user.tag}`);
        } else {
            console.log(`Command ${interaction.commandName} executed in ${interaction.guild.name} by ${interaction.user.tag}`);
        }
